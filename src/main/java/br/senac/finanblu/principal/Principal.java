...
public class Principal {
	...
	public static void main(String[] args) {
		...
		case EDITAR:
		  ...
		  empresas = dao.recuperarEmpresas(); 
		  listarEmpresas(empresas);
		  System.out.print("Selecione Uma Das Empresas Para Editar: ");
		  Empresa empresa = empresas.get(Integer.valueOf(leitor.next()) - 1);
		  ...
		  AtributoEmpresa atributoEmpresa = AtributoEmpresa.values()[Integer.parseInt(leitor.next()) - 1];
		  ...
		  case TELEFONE: 
			  ...
			  dao.atualizarTelefoneEmpresa(empresa, leitor.next());
			  break;
			  
		  case EMAIL:
			 System.out.println("\n");
			 System.out.println("Informe o novo Email Da Empresa");
			 dao.atualizarEmailEmpresa(empresa, leitor.next());
			 break;
		...
		case DELETAR:
			 System.out.print("\n");
			  ...
			  empresas = dao.recuperarEmpresas();
			  listarEmpresasNumeradas(empresas);
			  System.out.print("Selecione Uma Das Empresas Para deletar: ");
			  empresa = empresas.get(Integer.valueOf(leitor.next()) - 1);
	...
	private static void listarEmpresas(List<Empresa> empresas) {
		for (int i = 0; i < empresas.size(); i++) {
			...
			System.out.println("Razao Social: " + empresa.getPessoaJuridica().getRazaoSocial());
	 ...
	 private static void listarEmpresasNumeradas(List<Empresa> empresas) { 
		 for (int i = 0; i < empresas.size(); i++) {
			  Empresa empresa = empresas.get(i);
		...
		public static void main(String[] args) {
			...
			endereco.setCep("1023310");
			endereco.setLogradouro("fsafgsvdsba");
			endereco.setNumero((short) 123);
			endereco.setBairro("Bairaffasfr");
			endereco.setCidade("Cidaofqf");
			endereco.setUf("Rn");
			...
			contato.setEmail("s2bur32o.com");
			contato.setTelefone("4231621693");
			...
			pessoaJuridica.setRazaoSocial("se3m01a");
