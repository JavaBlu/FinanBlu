...
public class Servlet extends HttpServlet {
	...
	private void inserirEmpresa(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		daoEmpresa.inserirEmpresa(new Empresa(cnpj, razaoSocial, nomeFantasia, telefone, email, senha));
	...
	private void atualizarEmpresa(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		daoEmpresa.atualizarEmpresa(new Empresa(id, cnpj, razaoSocial, nomeFantasia, telefone, email, senha));
		response.sendRedirect("listar");
	}
...
/*	private void mostrarFormularioNovoCliente(HttpServletRequest request, HttpServletResponse response)
	...
	private void mostrarFormularioEditarCliente(HttpServletRequest request, HttpServletResponse response)
		...
		long id = Long.parseLong(request.getParameter("id"));
		Cliente cliente = daoCliente.recuperarClientes(new Cliente(id));
	...
	private void inserirCliente(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String nomeFantasia = request.getParameter("nome_fantasia_pessoa_juridica");
		String cnpj = request.getParameter("cnpj_pessoa_juridica");
		String cep = request.getParameter("cep_endereco");
		String logradouro = request.getParameter("logradouro_endereco");
		short numero = Short.parseShort(request.getParameter("numero_endereco"));
		String bairro = request.getParameter("bairro_endereco");
		String cidade = request.getParameter("cidade_endereco");
		String uf = request.getParameter("uf_endereco");
		String complemento = request.getParameter("complemento_endereco");
		
		daoCliente.InserirCliente(new Cliente());
		response.sendRedirect("listar");
	}

	private void atualizarCliente(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		String uf = request.getParameter("uf_endereco");
		String complemento = request.getParameter("complemento_endereco");
		daoCliente.atualizarCliente(new Cliente(id,telefone, email, razaoSocial, nomeFantasia, cnpj, cep, logradouro, numero, bairro, cidade, uf, complemento));
		response.sendRedirect("listar");
	}

	private void deletarCliente(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
